function myFunction() {
    var a = document.getElementById("myInput").selectedIndex;
    //document.getElementById("answer").value = document.getElementsByTagName("option")[grocery].value;
    var grocery = document.getElementsByTagName("option")[a].value;
    switch (grocery) {
      case "milk":
